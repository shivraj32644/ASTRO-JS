...
import type { IFormData } from '../../../api-requests/contact-us-form';
import { notify } from '../../../utils/notify';
import { CgSpinner } from 'react-icons/cg';
import { cmsApiInstance } from '../../../api-requests/common';
import { mobileField } from '../../../utils/yupSchema';
...
export function RRequestDemoModal({
  isOpen,
  closeModal,
}: {
  isOpen: boolean;
  ...
  const handleFormSubmit = (data: any) => {
    ...
    cmsApiInstance.post<{
        ...
        notify(toast,error?.response?.data?.error || error.error || 'Something went wrong! Please try again.',"error")
      }).finally(()=>{
        setIsLoading(false)
      })
